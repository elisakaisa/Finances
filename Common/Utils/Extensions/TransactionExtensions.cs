...
namespace Common.Utils.Extensions
{
    public static class TransactionExtensions
    {
        ...
        {
            return transactions.Where(t => t.Subcategory.CategoryId == categoryId).Sum(t => t.Amount);
        }
        ...
        {
            return transactions.Where(t => t.Subcategory.CategoryId == categoryId && t.UserId == userId).Sum(t => t.Amount);
        }
        ...
        {
            return transactions.Where(t => t.Subcategory.CategoryId == categoryId && t.User.HouseholdId == householdId).Sum(t => t.Amount);
        }
        ...
        {
            return transactions.Where(t => t.IsTransactionCommon() && t.UserId == userId).Sum(t => t.Amount);
        }
        public static decimal SumCommonExpensesByHousehold(this ICollection<Transaction> transactions, Guid householdId)
        {
            return transactions.Where(t => t.IsTransactionCommon() && t.User.HouseholdId == householdId).Sum(t => t.Amount);
        }
        #endregion
